export default function HeaderADM({NavBar,setNavBar}:{NavBar:boolean,setNavBar:any}){
    return (
    <header className="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        <div className="m-header">
            <a className="mobile-menu" onClick={()=>setNavBar(!NavBar)} id="mobile-collapse" href="#!"><span></span></a>
            <a href="{{url('/')}}" className="b-brand">
                <h1 className="text-xl font-bold text-yellow-600" >KingEvents</h1>
